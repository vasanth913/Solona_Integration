...
import AddAsChild from './addAsChild';
  
  
  const UpdateComponentNvd = ({connectionUrl, payerUrl}) => {
  ...
  return (
    <div className="App">
    {
        ...
        <AddAsChild connectionUrl={connectionUrl} payerUrl={payerUrl} />   
    }
    </div>
  )
  ...
  export default UpdateComponentNvd;
