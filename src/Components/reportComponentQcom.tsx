import {
  ...
  import UpdateComponentQcom from './updateComponentQcom';
  
  
  const ReportComponentQcom = ({connectionUrl, payerUrl }) => {
 ...
 async function reportComponentQcom(): Promise<void> {
  ...
  return (
    <div className="App">
    {
        ...
        <UpdateComponentQcom connectionUrl={connectionUrl}  payerUrl={payerUrl} />   
    }
</div>
  )
  ...
  export default ReportComponentQcom;
